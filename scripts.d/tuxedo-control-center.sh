...
then
    ...
    wget https://deb.tuxedocomputers.com/ubuntu/pool/main/t/tuxedo-archive-keyring/tuxedo-archive-keyring_2024.04.01~tux1_all.deb -O ~/Downloads/tuxedo-archive-keyring.deb
    ...
    https://deb.tuxedocomputers.com/$(lsb_release -is | awk '{print tolower($0)}') $(lsb_release -cs) main" | sudo tee /etc/apt/sources.list.d/tuxedo.list > /dev/null
